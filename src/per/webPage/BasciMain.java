...
public class BasciMain extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BasicGridMap map = new BasicGridMap(sizeX, sizeY);
		BasicNode start = new BasicNode(1, 1);
		BasicNode  destination = new BasicNode(12,6);
	...
	public String listToJSONstr(List<NodeAble> list) {
	    	...
	    	for(NodeAble node : list) {
	    		double y = node .getPositionY() + 0.5;
	    		double x = node .getPositionX() + 0.5;
	    		sb.append("{");
	    		sb.append("\'x\':"+x+",");
	    		sb.append("\'y\':"+y+"}");
	    		sb.append(",");
