 ...
 */
@WebServlet("/FDMain")
public class FDMain extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		FDMap map = new FDMap(sizeX, sizeY);
		EdgeNode start = new EdgeNode(0, map.getEdge(2, 4, false));
		EdgeNode destination = new EdgeNode(0, map.getEdge(sizeX / 3,  sizeX-1, false));
